...
CFG_CHIPSET_PATH :=ap/platform/hi6210sft
...
CFG_GU_NV_PATH :=ap/config/nvim/data/gu/bin_dsda
CFG_GU_NV_XML_FLAG := YES
CFG_GU_NV_XML_PATH :=ap/config/nvim/data/gu/hi6210
CFG_GU_XNV_PATH :=ap/config/nvim/data/gu/v8r1/sft
...
CFG_GU_FEATURE_CONFIG_PATH :=ap/config/product/hi6210sft/include
CFG_MCU_INCLUDE                         := YES
...
CFG_FEATURE_ICC_DEBUG                           := FEATURE_OFF
...
CFG_FEATURE_TTF_MEM_DEBUG                       := FEATURE_OFF
