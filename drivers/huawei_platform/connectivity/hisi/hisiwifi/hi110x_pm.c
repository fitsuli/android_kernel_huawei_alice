 ...
 */
/* Start of zhangwei 64406 2013-03-26 B295 ����Ԥ����� */
...
/* DTS2013120901517  Hi110x bug fix z00209041 ���ڣ�2013��/11��/8�գ� begin */
/*
...
/* DTS2013120901517   Hi110x bug fix z00209041 ���ڣ�2013��/11��/8�գ� end */
...
void hi110x_pm_feed_wdg(struct hi110x_pm_info *pm_info)
{
    ...
    /* DTS2013121206795   Hi110x bug fix z00209041 ���ڣ�2013��/11��/8�գ� begin */
    if (!g_powermgmt_switch)
    {
        HWIFI_INFO("lower power switch is off");
        return;
    }
    /* DTS2013121206795   Hi110x bug fix z00209041 ���ڣ�2013��/11��/8�գ� end */
     ...
     * 2�������ɹ�
     */
    /* DTS2013110501752   Hi110x bug fix �Ż�/z00209041 ���ڣ�2013��/11��/8�գ� begin */
    if (IS_STA(cfg) && IS_CONNECTED(cfg) && IS_GET_IPADDR(pm_info))
    /* DTS2013110501752   Hi110x bug fix �Ż�/z00209041 ���ڣ�2013��/11��/8�գ� end */
    {
...
int32 hi110x_reduce_freq_process(struct cfg_struct *cfg)
{
    ...
    /**
     * ����Ƶ�����շ�����������
     * ������ MAXCAP_40MHZ_RATE...........cpuƵ��40MHz
     * ������ 80MHZ_MAXCAP_RATE...........cpuƵ��80MHz
     * ������ 160MHZ_MAXCAP_RATE..........cpuƵ��160MHz
     * ������ 240MHZ_MAXCAP_RATE..........cpuƵ��240MHz
     */
    switch (last_cpufreq)
    {
        case WLCPU_40MHZ:
...
/* Start of zhangwei 64406 2013-03-26 B295 ����Ԥ����� */
#endif
/* End of zhangwei 64406 2013-03-26 B295 ����Ԥ����� */
