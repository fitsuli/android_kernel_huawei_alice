...
/*****************************************************************************
 �� �� ��  : hwifi_test_freq_set
 ��������  : ����wifiƵ��
 �������  : struct cfg_struct *cfg, uint8  enabled
 �������  : ��
 �� �� ֵ  :
 ���ú���  :
 ��������  :
...
int32 hwifi_dbb_get(struct cfg_struct *cfg,int8 *dbb)
{
    ...
    memcpy(dbb,cfg->hi110x_dev->tps->dbb,HISI_WIFI_DBB_LEN);
